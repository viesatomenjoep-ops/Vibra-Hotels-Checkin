...
export const translations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    pitch_hotel_placeholder: 'Bijv. Jet Hotels',
    pitch_hotel_slug: 'Hotel ID (Unieke URL naam)',
    pitch_scooter_name: 'Naam Verhuurbedrijf',
    pitch_scooter_placeholder: 'Bijv. Ibiza Scooters',
    pitch_scooter_slug: 'Verhuurbedrijf ID (Unieke URL naam)',
    pitch_scooter_fleet_title: 'Scooter Vloot (Aanbod)',
    pitch_scooter_name_label: 'Scooter Naam',
    pitch_scooter_cc_label: 'CC / Type',
    pitch_scooter_price_label: 'Prijs/dag',
    pitch_scooter_add_btn: '+ Voeg Scooter Toe',
    pitch_scooter_upload_img: 'Kies Foto',
    ...
    pitch_error_hotel_required: 'Hotel Naam en ID (slug) zijn verplicht.',
    pitch_error_scooter_required: 'Verhuurbedrijf Naam en ID (slug) zijn verplicht.',
    ...
    login_subtitle: 'Log in op je Viesa account',
    ...
    register_subtitle: 'Start gratis met je Viesa platform',
    full_name_label: 'Volledige Naam',
    register_button: 'Account Aanmaken',
    register_loading: 'Bezig met aanmaken...',
    already_account: 'Heb je al een account?',
    login_link: 'Log hier in',
    promo_code_label: 'Promotiecode (Optioneel)',
    promo_code_placeholder: 'Bijv. VIESA2026',
    onboarding_title: 'Welkom bij Viesa',
    onboarding_subtitle: 'Laten we je bedrijfsomgeving inrichten',
    branch_hotel: 'Hotel',
    branch_rental: 'Verhuurbedrijf (Scooters/Auto\'s)',
    branch_beachbeds: 'Strand & Beachbeds',
    company_name_label: 'Bedrijfsnaam',
    company_name_placeholder: 'Jouw bedrijfsnaam',
    complete_setup: 'Afronden & Starten'
  },
  en: {
    ...
    pitch_hotel_placeholder: 'E.g. Jet Hotels',
    pitch_hotel_slug: 'Hotel ID (Unique URL name)',
    pitch_scooter_name: 'Rental Company Name',
    pitch_scooter_placeholder: 'E.g. Ibiza Scooters',
    pitch_scooter_slug: 'Rental Company ID (Unique URL name)',
    pitch_scooter_fleet_title: 'Scooter Fleet (Inventory)',
    pitch_scooter_name_label: 'Scooter Name',
    pitch_scooter_cc_label: 'CC / Type',
    pitch_scooter_price_label: 'Price/day',
    pitch_scooter_add_btn: '+ Add Scooter',
    pitch_scooter_upload_img: 'Choose Photo',
    ...
    pitch_error_hotel_required: 'Hotel Name and ID (slug) are required.',
    pitch_error_scooter_required: 'Rental Company Name and ID (slug) are required.',
    ...
    login_subtitle: 'Log in to your Viesa account',
    ...
    register_subtitle: 'Start your Viesa platform for free',
    ...
    promo_code_placeholder: 'E.g. VIESA2026',
    onboarding_title: 'Welcome to Viesa',
    onboarding_subtitle: 'Let\'s set up your business environment',
    branch_hotel: 'Hotel',
    branch_rental: 'Rental Company (Scooters/Cars)',
    branch_beachbeds: 'Beach & Beachbeds',
    company_name_label: 'Company Name',
    company_name_placeholder: 'Your company name',
    complete_setup: 'Complete Setup & Start'
  },
  es: {
    ...
    pitch_hotel_placeholder: 'Ej. Jet Hotels',
    pitch_hotel_slug: 'ID del Hotel (Nombre URL único)',
    pitch_scooter_name: 'Nombre de la Empresa de Alquiler',
    pitch_scooter_placeholder: 'Ej. Ibiza Scooters',
    pitch_scooter_slug: 'ID de la Empresa de Alquiler (URL única)',
    pitch_scooter_fleet_title: 'Flota de Scooters (Inventario)',
    pitch_scooter_name_label: 'Nombre del Scooter',
    pitch_scooter_cc_label: 'CC / Tipo',
    pitch_scooter_price_label: 'Precio/día',
    pitch_scooter_add_btn: '+ Añadir Scooter',
    pitch_scooter_upload_img: 'Elegir Foto',
    ...
    pitch_error_hotel_required: 'El Nombre y el ID del Hotel son obligatorios.',
    pitch_error_scooter_required: 'El Nombre y el ID de la Empresa son obligatorios.',
    ...
    login_subtitle: 'Inicia sesión en tu cuenta Viesa',
    ...
    register_subtitle: 'Inicia tu plataforma Viesa gratis',
    ...
    promo_code_placeholder: 'Ej. VIESA2026',
    onboarding_title: 'Bienvenido a Viesa',
    onboarding_subtitle: 'Configuremos el entorno de su negocio',
    branch_hotel: 'Hotel',
    branch_rental: 'Empresa de Alquiler (Motos/Coches)',
    branch_beachbeds: 'Playa y Hamacas',
    company_name_label: 'Nombre de Empresa',
    company_name_placeholder: 'El nombre de tu empresa',
    complete_setup: 'Finalizar y Empezar'
  },
  de: {
